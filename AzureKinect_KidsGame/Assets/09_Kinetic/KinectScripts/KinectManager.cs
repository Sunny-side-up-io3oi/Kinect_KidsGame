...
//	public bool NearMode = false;
	...
	//   Texture to display the hand cursor for Player1
							...
							gestureData.progress >= 0.5f)
						{
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								if(HandCursor1 != null)
								{
									...
									if(HandCursor1.GetComponent<Renderer>() == null)
									{
								...
								if(ControlMouseCursor)
								{
									Vector3 vCursorPos = HandCursor1.GetComponent<Renderer>() != null ? HandCursor1.transform.position :
							...
							gestureData.progress >= 0.5f)
						{
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								if(HandCursor2 != null)
								{
									...
									if(HandCursor2.GetComponent<Renderer>() == null)
									{
								...
								if(ControlMouseCursor)
								{
                                    Vector3 vCursorPos = HandCursor2.GetComponent<Renderer>() != null ? HandCursor2.transform.position : Vector3.zero;
